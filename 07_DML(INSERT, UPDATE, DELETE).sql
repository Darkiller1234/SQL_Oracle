...
/*
    ...
    => NOT NULL제약조건이 걸려있는 컬럼은 반드시 직접 값을 넣어줘야한다.ㅣ
    단, 기본값이 지정되어 있으면 NULL이 아닌 기본값이 들어감.
*/

INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
VALUES(901, '윤대한', '020702-1234567', 'J7', SYSDATE);
...
--부서코드가 D1인 사람들의 사번, 이름, 부서코드, 입사일, 사수사번을 조회
...
--방명수 사원의 급여와 보너스값을 유재식사원의 급여와 보너스값을 ㅗ변경
UPDATE EMP_SALARY
