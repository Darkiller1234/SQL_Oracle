/* 
    *데이터 정의 언어
    오라클에서 제공한는 객체를 새로 만들고(CREATE), 구조를 변경하고(ALTER), 구조 자체를 삭제(DELETE)하는 언어
...
INSERT INTO MEMBER
VALUES(1, 'USER1', 'PASS1', '홍길동', '나',  '010-1111-2222', 'AAA@NAVER.COM', '24/08/12');

INSERT INTO MEMBER
VALUES(1, 'USER1', 'PASS1', NULL, NULL,  '010-1111-2222', 'AAA@NAVER.COM', '24/08/12');
...
/*
    *NOT NULL
    ...
    NOT NULL제약조건은 무조건 컬럼레벨방식으로만 가능.
*/
...
VALUES(1, 'UESR1', 'PASS1', '홍길동', '남', '010-1111-2222', 'HOW@NAVER.COM',
'24/0812');

SELECT * FROM MEM_NOTNULL;

INSERT INTO MEM_NOTNULL
VALUES(2, 'UESR2', 'PASS2', '홍길순', NULL, NULL, NULL, NULL);
...
INSERT INTO MEM_NOTNULL
VALUES(3, 'UESR2', 'PASS3', '홍길삼', NULL, NULL, NULL, NULL);
...
INSERT INTO MEM_UNIQUE
VALUES(2, 'USER1', 'PASS2', '홍길순', '여', '010-1111-2222', 'aaa@NAVER.COM', '24/01/01');
-- UNIQUE제약조건에 위배되었으므로 INSERT 실패
--> 오류를 제약조건명으로 알려줌
--> 쉽게 파악하기 어려움
--> 제약조건 부여시 제약조건명 지정가능(지정하지 않으면 시스템에서 자동부여)
...
CREATE TABLE MEM_UNIQUE(
    ...
    EMAIL VARCHAR2(50),
    MEM_DATE DATE,
    CONSTRAINT MEMNO_UQ UNIQUE(MEM_ID) --테이블레벨 방식
);
...
INSERT INTO MEM_UNIQUE
VALUES(2, 'USER2', 'PASS2', '홍길순', '여', '010-1111-2222', 'aaa@NAVER.COM', '24/01/01');

INSERT INTO MEM_UNIQUE
VALUES(3, 'USER3', 'PASS3', '홍길삼', NULL, '010-1111-2222', 'aaa@NAVER.COM', '24/01/01');

INSERT INTO MEM_UNIQUE
VALUES(4, 'USER4', 'PASS4', NULL, NULL, '010-1111-2222', 'aaa@NAVER.COM', '24/01/01');
...
/*
    ...
    테이블에서 각 행(ROW)을 식별하기위해 직급코드, 주민번호, 주문번호 ...
...
CREATE TABLE TB_LIKE(
    ...
    LIKE_DATE DATE,
    PRIMARY KEY(MEN_NO, PRODUCT_NAME)
);
...
INSERT INTO MEM_GRADE VALUES (30, '특별회원회원');
...
INSERT INTO MEM
VALUES(1, 'USER1', 'PASS01', '홍길동', '남',NULL,NULL,NULL);
INSERT INTO MEM
VALUES(2, 'USER2', 'PASS02', '홍길순', '남',NULL,NULL,10);
INSERT INTO MEM
VALUES(3, 'USER3', 'PASS03', '최지원', '남',NULL,NULL,20);
INSERT INTO MEM
VALUES(4, 'USER4', 'PASS04', '김수민', '여',NULL,NULL,30);
INSERT INTO MEM
VALUES(5, 'USER5', 'PASS05', '박지민', '여',NULL,NULL,40);
...
INSERT INTO MEMBER VALUES(3,'응애', 20, DEFAULT, DEFAULT);

--INSERT INTO 테이블명(컬럼1, 컬럼2..) VALUES (컬럼1갑스 컬럼2값)
INSERT INTO MEMBER(MEM_NO, MEM_NAME) VALUES (4, '이강인');
-->선택안된컬럼에는NULL들어감
-->단, 해당 칼람에 DEFAULT값이 부여되어 있을경우 NULL이 아닌 DEFAULT값이 들어감.
...
--ALTER TABLE EMPLOYEE MODIFY EMP_ NOT NULL;
