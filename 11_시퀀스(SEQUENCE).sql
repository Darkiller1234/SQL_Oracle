...
/*
    ...
    [INCREMENT HY 숫자] -> 몇씩 증가시킬 건지(기본값 1)
    ...
    *캐시메모리 : 미리 발생될 값들을 생성해서 저장해두는 공간
                ...
                캐시메모리공간에 미리 생산된 값들을 가져다 쓸 수 있다.
...
/*
    ...
    시퀀스명.NEXTFAL : 시퀀스 값에 일정한 값ㅇ르 증가시켜 발생한 값
...
INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
        VALUES(SEQ_EID.NEXTVAL, '김말똥', '111111-211111', 'J6', SYSDATE);
        
SELECT * FROM EMPLOYEE;

INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
        VALUES(SEQ_EID.NEXTVAL, '윤대한', '111111-211111', 'J6', SYSDATE);
